            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full border-1 border-gray-500 rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
                />
              </div>
            </div>
